...
<body>
	...
	<section class="hero-section overflow-hidden">
		<div class="hero-slider owl-carousel">
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="usertemplet/img/slider-bg-1.jpg">
				<div class="container">
					<h2>Game on!</h2>
					...
					<a href="#" class="site-btn">Read More  <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></a>
				</div>
			</div>
			<div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="usertemplet/img/slider-bg-2.jpg">
				<div class="container">
					<h2>Game on!</h2>
					<p>Fusce erat dui, venenatis et erat in, vulputate dignissim lacus. Donec vitae tempus dolor,<br>sit amet elementum lorem. Ut cursus tempor turpis.</p>
					<a href="#" class="site-btn">Read More  <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></a>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
						...
						<a href="#" class="read-more">Read More  <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
			...
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7">
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="usertemplet//img/blog/1.jpg" alt="">
						</div>
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="usertemplet//img/blog/2.jpg" alt="">
						</div>
						<div class="blog-text text-box text-white">
							<div class="top-meta">11.11.18  /  in <a href="">Games</a></div>
							<h3>The best online game is out now!</h3>
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="usertemplet//img/blog/3.jpg" alt="">
						</div>
						<div class="blog-text text-box text-white">
							<div class="top-meta">11.11.18  /  in <a href="">Games</a></div>
							<h3>The best online game is out now!</h3>
				...
				<div class="col-xl-3 col-lg-4 col-md-5 sidebar">
					<div id="stickySidebar">
						...
						<div class="widget-item">
						<a href="#" class="add">
							<img src="usertemplet//img/add.jpg" alt="">
						</a>
					</div>
					</div>
				</div>
	...
	<!-- Intro section -->
	<section class="intro-video-section set-bg d-flex align-items-end " data-setbg="usertemplet//img/promo-bg.jpg">
		<a href="https://www.youtube.com/watch?v=uFsGy5x_fyQ" class="video-play-btn video-popup"><img src="usertemplet/img/icons/solid-right-arrow.png" alt="#"></a>
		<div class="container">
	...
	<section class="featured-section">
		<div class="featured-bg set-bg" data-setbg="usertemplet/img/featured-bg.jpg"></div>
	...
	<section class="newsletter-section">
		<div class="container">
			...
			<form class="newsletter-form">
				...
				<button class="site-btn">subscribe  <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></button>
			</form>
		</div>
	</section>
