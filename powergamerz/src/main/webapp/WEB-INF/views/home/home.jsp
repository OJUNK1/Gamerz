...
<body>
				...
				<div class="col-xl-9 col-lg-8 col-md-7">
					...
					<div class="blog-item">
						...
						<div class="blog-text text-box text-white">
							...
							<p>■전투의 무대를 지배하라 「Fighting Ground(파이팅 그라운드)」에서는 시리즈를 계승한 격투
					...
					<div class="blog-item">
						...
						<div class="blog-text text-box text-white">
							...
							<p>2330년, 인류는 태양계 너머로 나섰습니다. 우주로 영토를 넓히며 새로운 행성에 정착한 거죠. 여러분은
					...
					<div class="blog-item">
						...
						<div class="blog-text text-box text-white">
							...
							<p>・자극으로 가득한 드넓은 세계 다채로운 시추에이션을 지닌 탁 트인 필드와 복잡하면서 입체적으로 짜인
	...
	<section class="intro-video-section set-bg d-flex align-items-end "
		data-setbg="usertemplet/img/promo-bg.jpg">
		<a href="https://www.youtube.com/watch?v=uFsGy5x_fyQ"
			class="video-play-btn video-popup"><img
			src="usertemplet/img/icons/solid-right-arrow.png" alt="#"></a>
		<div class="container">
	...
	<section class="featured-section">
		<div class="featured-bg set-bg"
			data-setbg="usertemplet/img/featured-bg.jpg"></div>
