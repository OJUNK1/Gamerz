...
<div align="center">
	...
	<div>
			...
			<button type="button" class="site-btn" onclick="faqUpdate('E')">수정 <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></button>&nbsp;&nbsp;&nbsp;
			<button type="button" class="site-btn" onclick="faqUpdate('D')">삭제 <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></button>&nbsp;&nbsp;&nbsp;			
			<%-- </c:if> --%>
			<button type="button" class="site-btn" onclick="location.href='faqlist.do'">목록 <img src="usertemplet/img/icons/double-arrow.png" alt="#"/></button>
			</div>			
			<div>
